...
- Name: performance-a11y.spec.ts >> Performance & Accessibility >> products page should load within time limit
- Location: tests\performance-a11y.spec.ts:103:7
...
```ts
  ...
  14  |     const mobileMenu = page.locator('[data-testid="mobile-menu"], [aria-label="menu"]');
  15  |     if (await mobileMenu.isVisible()) {
